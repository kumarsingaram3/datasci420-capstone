...
The goal of this project was to go through a real life business case, clean & prepare messy data, handle class imbalance, and build & test each of the algorithms learned in class.
